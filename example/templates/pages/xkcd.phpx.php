...
return \Phpx\Templates\ThemedResult::create('theme')
    ->withBlock('title', 'XKCD : ' . $options->id)
    ->withBlock('github-link', 'https://github.com/buttress/phpx/blob/main/eample/templates/pages/xkcd.phpx.php')
    ->withBlock('content', $x->div(class: 'container mx-auto pt-4', c: [
